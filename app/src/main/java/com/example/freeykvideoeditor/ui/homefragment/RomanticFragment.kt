 ...
 * Use the [RomanticFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RomanticFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RomanticFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RomanticFragment().apply {
